...
(function (root, factory) {
	...
	function constructDialog($dialog) {
		...
		return $(
			'<div class="modal fade" id="prog" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true" style="padding-top:15%; overflow-y:visible;">' +
	...
	return {
		...
		show: function (message, options) {
			...
			$dialog[0].style.transition = "opacity  0.3s linear 0s";
			...
			// Opening dialog
			$dialog.modal();
			setTimeout(function() {$dialog[0].style.opacity = 1}, 500);
