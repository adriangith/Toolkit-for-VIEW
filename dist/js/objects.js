let config = [
    ...
    },
    {
        ...
        "targetTags": [
            ...
            { field: "Pre_payments", tag: '#lblPrePayments', method: 'text' },
            { field: "Amount_Paid", tag: '#lblPayments', method: 'text' },
            { field: "Refunds", tag: '#lblRefunds', method: 'text' },
            { field: "Returns", tag: '#lblReturnChqs', method: 'text' },
            { field: "lblReversedFees", tag: '#lblReversedFees', method: 'text' },
            { field: "Cancellations", tag: '#lblCancellations', method: 'text' },
            { field: "Writeoff", tag: '#lblWritteoffs', method: 'text' },
            { field: "Amount_Waived", tag: '#lblWaiveAmt', method: 'text' },
            { field: "Court_costs_3A", tag: '#lblCourtCosts', method: 'text' },
            { field: "Hearing_costs", tag: '#lblAppealCosts', method: 'text' },
            { field: "Transfer_In", tag: '#lblTransferIns', method: 'text' },
            { field: "Transfer_Outs", tag: '#lblTransferOuts', method: 'text' },
